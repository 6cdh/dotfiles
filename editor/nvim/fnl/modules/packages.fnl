...
(fn verify [pkg-lst]
  (fl.all #$1.name pkg-lst))

{:name "name"
 :enable true
 :config "config when load"
 :lazy {:cmd "command"
        :event "event"
        :after "plugin name should load before me"}
 :update "command after update"
 :dep "list of dependencies names"}
